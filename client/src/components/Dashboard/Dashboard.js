    ...
    <div style={{
      ...
      {new Date().toLocaleDateString('en-US', {
        ...
        day: 'numeric'
          ...
          {/* See More Button - Before Today's Appointments */}
          <div style={{
            display: 'flex',
            justifyContent: 'flex-end',
            marginTop: '2.5rem',
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.target.style.boxShadow = '0 12px 32px rgba(42, 63, 157, 0.4)';
                e.target.style.background = 'linear-gradient(135deg, #1f2d6d 0%, #3d5fe1 100%)';
              }}
              onMouseLeave={(e) => {
                e.target.style.transform = 'translateY(0)';
                e.target.style.boxShadow = '0 8px 24px rgba(42, 63, 157, 0.3)';
                e.target.style.background = 'linear-gradient(135deg, #2a3f9d 0%, #4a6cf7 100%)';
              }}
              title="View detailed analytics and insights"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M13 5h8m0 0v8m0-8l-11 11M3 3v8m0 0h8m0 0L3 14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              See More
            </button>
          </div>
